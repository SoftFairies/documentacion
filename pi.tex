...
\begin{itemize}
	\item \textbf{INEGI.} (2025). \textit{Módulo sobre Lectura (MOLEC)}. \\
	Enlace: \url{https://share.google/oSIT0jhQy8hLjdmqe}
	
	\item \textbf{Dialnet.} (2024). \textit{Factores que afectan el hábito de la lectura: un problema de la sociedad actual}. \\
	Enlace: \url{https://share.google/RAG5lluZnsl7iiICb}
	
	\item \textbf{Revista OCNOS.} (2009). \textit{Aunque lea poco, yo sé que estoy listo}. \\
	Enlace: \url{https://share.google/1MDzQisS2FaRMtEf9}
	
	\item \textbf{E-Ciencias de la Información.} (2020). \textit{Hábitos de lectura en alumnos de primer ingreso de psicología educativa de la Universidad Pedagógica Nacional (UPN), México}. Vol. 10, N° 1. \\
	Enlace: \url{https://www.scielo.sa.cr/scielo.php?script=sci_arttext&pid=S1659-41422020000100231}
	
	\item \textbf{RIDE. Revista Iberoamericana para la Investigación y Desarrollo Educativo.} (2025). \textit{Las creencias de estudiantes de secundaria sobre la lectura}. Vol. 15, N° 30. \\
	Enlace: \url{https://www.scielo.org.mx/scielo.php?script=sci_arttext&pid=S2007-74672025000100135}
\end{itemize}
