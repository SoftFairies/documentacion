...
\begin{enumerate}
    \item[A.] \textbf{Pruebas funcionales:}
    \begin{itemize}
        \item [Describir flujos end-to-end, casos de borde, validaciones, etc.]
    \end{itemize}
    \item[B.] \textbf{Pruebas de interfaz y experiencia de usuario (UI/UX):}
    \begin{itemize}
        \item [Describir pruebas de responsividad, consistencia, accesibilidad, etc.]
    \end{itemize}
    \item[C.] \textbf{Pruebas de rendimiento:}
    \begin{itemize}
        \item [Describir métricas de carga, consumo de recursos, red y estrés.]
    \end{itemize}
    \item[D.] \textbf{Pruebas de compatibilidad y portabilidad:}
    \begin{itemize}
        \item [Describir pruebas cross-browser, cross-platform, orientación e instalación.]
    \end{itemize}
    \item[E.] \textbf{Pruebas de seguridad básicas:}
    \begin{itemize}
        \item [Describir manejo de sesiones, almacenamiento seguro, HTTPS y permisos.]
    \end{itemize}
    \item[F.] \textbf{Pruebas de integración (API / terceros):}
    \begin{itemize}
        \item [Describir integraciones externas y manejo de errores HTTP.]
    \end{itemize}
    \item[G.] \textbf{Pruebas de localización e idioma:}
    \begin{itemize}
        \item [Describir verificación de idiomas, formatos y traducciones.]
    \end{itemize}
\end{enumerate}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textit{Rendimiento (Core Web Vitals):}
        \begin{table}[H]
        \centering
        \small
        ...
        LCP (Largest Contentful Paint) & [Descripción] & [Umbral] \\ \hline
        INP (Interaction to Next Paint) & [Descripción] & [Umbral] \\ \hline
        CLS (Cumulative Layout Shift) & [Descripción] & [Umbral] \\ \hline
        \end{tabular}
        \caption{Métricas Core Web Vitals.}
        \label{tab:core_web_vitals}
        \end{table}
        \item [Describir gestión de estado, almacenamiento local y consumo de APIs.]
    \end{itemize}
    \item \textbf{Cliente móvil — iOS y Android}
    \begin{itemize}
        \item [Describir gestión de recursos, integración con SO y persistencia segura.]
    \end{itemize}
    \item \textbf{Backend / API — Integración entre plataformas}
    \begin{itemize}
        \item [Describir concurrencia, sincronización y consistencia de reglas de negocio.]
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item \textbf{Bloqueante / crítico:} [Definir criterio]
    \item \textbf{Mayor:} [Definir criterio]
    \item \textbf{Menor / cosmético:} [Definir criterio]
\end{itemize}
...
\begin{itemize}
    \item \textbf [Incluir recomendaciones de acción basadas en los resultados.]
\end{itemize}
