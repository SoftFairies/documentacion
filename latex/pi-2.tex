...
\end{table}
    ...
    \begin{itemize}
        \item Gestión de recursos de hardware, fugas de memoria y comportamiento en segundo plano.
        \item Integración con el sistema operativo y persistencia local segura.
    \end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./fotos/sirgei/jmeter-simultaneo-fallido.png}
    \caption{Prueba de carga simultánea en JMeter con fallos registrados.}
    \label{fig:jmeter_simultaneo_fallido}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./fotos/sirgei/jmeter-simultaneo.png}
    \caption{Resultados exitosos de la prueba de carga simultánea en JMeter.}
    \label{fig:jmeter_simultaneo}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./fotos/sirgei/login.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./fotos/sirgei/2fa.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./fotos/sirgei/add-2fa.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./fotos/sirgei/email.png}
    \caption{Notificación y verificación por correo electrónico.}
    \label{fig:email}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./fotos/sirgei/entrar.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./fotos/sirgei/login-postman.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./fotos/sirgei/email-postman.png}
    \caption{Petición API para envío o validación de correo en Postman.}
    \label{fig:email_postman}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{./fotos/sirgei/verify-2fa-postman.png}
    \caption{Verificación del endpoint de autenticación 2FA en Postman.}
    \label{fig:verify_2fa_postman}
\end{figure}
