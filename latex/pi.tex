...
\begin{longtable}{|p{1.0cm}|p{2.2cm}|p{3.0cm}|p{3.5cm}|p{3.8cm}|}
	...
	\textbf{CP-07} & Gamificación & Actualización atómica de racha de lectura (\textit{streak}). & Registrar una sesión de lectura válida en el día actual tras haber leído el día anterior. & El caso de uso evalúa la fecha, incrementa la racha consecutiva en $+1$ y persiste el cambio en la BD. \\ \hline
	...
	\textbf{CP-09} & Métricas & Carga de estadísticas globales en el panel analítico. & Navegar a la ruta \path{/estadisticas} para consultar los gráficos de rendimiento e historial. & El controlador calcula y devuelve las métricas agregadas en formato JSON en un tiempo menor a 300 ms. \\ \hline
