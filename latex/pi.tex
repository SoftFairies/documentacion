...
% Escribir aquí las acciones que realiza el sistema (ej. El sistema debe...)

\subsection{Requerimientos no funcionales}
% Escribir aquí rendimiento, seguridad, usabilidad, etc.

\subsection{Identificación de los actores del sistema}
% Presentar tabla con los roles (Administrador, Usuario, etc.)
...
% Presentar entidad-relación y descripción de tablas
