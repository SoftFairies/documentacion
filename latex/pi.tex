...
\begin{itemize}
    \item \textbf{Clientes de Usuario (Capa de Presentación):} Representan el extremo 'Cliente' en la arquitectura. Al ser interfaces inteligentes y totalmente independientes del motor de base de datos, gestionan su propio enrutamiento visual y la experiencia de usuario:
    \begin{itemize}
...
% ==============================================================================
% ESPACIO RESERVADO PARA EL FRONTEND
% ==============================================================================
\subsubsection{Interfaz Gráfica (Frontend)}
% \begin{figure}[H]
%     \centering
%     % \includegraphics[width=0.9\textwidth]{img/vista-dashboard.png}
%     \caption{Vista principal del tablero de usuario en la aplicación.}
%     \label{fig:front_dashboard}
% \end{figure}
